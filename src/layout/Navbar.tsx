...
const Navbar = () => {
    ...
    return (
        <div className="text-white flex justify-between items-center h-[60px] pr-24 pl-24 navbar">
            ...
            <Button className="text-4xl font-bold cursor-pointer bg-[#4ca2cd] text-white">Go</Button>
            </Link>
            ...
            <div className="flex gap-2 items-center">
               ...
               <Button className="text-lg font-bold flex justify-center items-center text-[#4ca2cd]   w-24 h-10 cursor-pointer">Sign out</Button>
